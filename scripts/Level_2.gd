#-----------------------------------------------------------------------------
# Name:        Level 2 Script
# Purpose:     handles scene transitions by detecting player interaction with transition areas and 
#    		   changing scenes accordingly, particularly transitioning from "Level_2" to the "world" 
...
func _on_world_transition_2_body_entered(body):
	'''
...
func _on_world_transition_2_body_exited(body):
	'''
...
func change_scenes():
	...
	If transitioning from Level_2, it changes to the world scene and updates the global state.

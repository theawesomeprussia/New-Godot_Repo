#-----------------------------------------------------------------------------
# Name:        Level 3 Script 
# Purpose:     Manages scene transitions, detecting player interaction with transition 
#              areas and changing scenes accordingly, focusing on transitioning from "Level_3" 
#              to the "world" scene when necessary.
#
# References: 	
...
func _on_world_transition_3_body_entered(body):
	'''
...
func _on_world_transition_3_body_exited(body):
	'''
...
func change_scenes():
	...
	If transitioning from Level_3, it changes to the world scene and updates the global state.
